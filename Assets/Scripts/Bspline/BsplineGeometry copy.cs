...
//     NativeArray<float2> derivative2;   // 出力点　N
...
//         derivative2 = new NativeArray<float2>(N, Allocator.Persistent);
...
//             // SetD1Rx1du11(trajectoryGenerator.bsplineDerivative1Native[u1Index].x);
//             // SetD1Ry1du11(trajectoryGenerator.bsplineDerivative1Native[u1Index].y);

//             // R(u2)
//             SetRx2(trajectoryGenerator.bsplineNative[u2Index].x);
//             SetRy2(trajectoryGenerator.bsplineNative[u2Index].y);

//             // SetD1Rx2du21(trajectoryGenerator.bsplineDerivative1Native[u2Index].x);
//             // SetD1Ry2du21(trajectoryGenerator.bsplineDerivative1Native[u2Index].y);
...
//     public NativeArray<float2> Derivative1AllPoints()
//     {
...
//         int n1 = beta1.Length - 1;

//         float u_min1 = knots1[k-1];
//         float u_max1 = knots1[n1 + 1];

//         using(DerivativePointsMarker.Auto())
//         {
//             var job = new BSplineDerivativeJob {
//                 ctrl = beta1,
//                 knots = knots1,
//                 degree = k-1,
//                 u_min_ori = u_min, // 元の曲線のu_min
//                 u_max_ori = u_max, // 元の曲線のu_max
//                 u_min = u_min1, // 現曲線のu-minではない
//                 u_max = u_max1, // 1996
//                 results = derivative1
//             };
...
//     public NativeArray<float2> Derivative2AllPoints()
//     {

//         // float u_min2 = knots2[k-2];
//         // float u_max2 = knots2[(beta2.Length - 1) + 1];

//         int n2 = beta2.Length - 1;

//         float u_min2 = knots2[k-2];
//         float u_max2 = knots2[n2 + 1];
...
//         // float u1_d1 = math.lerp(knots1[k-1], knots1[n1+1], (float)idx1/(N-1));
//         // float u1_d2 = math.lerp(knots2[k-2], knots2[n2+1], (float)idx1/(N-1));

//         int n1 = beta1.Length - 1;
//         int n2 = beta2.Length - 1;
//         int n3 = beta3.Length - 1;
//         int n4 = beta4.Length - 1;
...
//         float u_min3 = knots3[k-3];
//         float u_max3 = knots3[n3 + 1];

//         float u_min4 = knots4[k-4];
//         float u_max4 = knots4[n4 + 1];
...
//         if (derivative2.IsCreated) derivative2.Dispose();
